...
public class SmelterRecipeBuilder implements RecipeBuilder {
    ...
    public SmelterRecipeBuilder(ItemLike ingredient, ItemLike result, int count) {
    ...
    public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pRecipeId) {
        ...
        pFinishedRecipeConsumer.accept(new SmelterRecipeBuilder.Result(pRecipeId, this.result, this.count, this.ingredient,
    ...
    public static class Result implements FinishedRecipe {
        ...
        public ResourceLocation getId() {
            return new ResourceLocation(TutorialMod.MOD_ID,
                    this.result.getRegistryName().getPath() + "_from_smelting_" + ingredient.getItems()[0].getItem().getRegistryName().getPath());
        }
