...
public class ModConfiguredFeatures {
    ...
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ALUMINUM_ORE = FeatureUtils.register("aluminum_ore",
            Feature.ORE, new OreConfiguration(OVERWORLD_ALUMINUM_ORES, 9));
}
